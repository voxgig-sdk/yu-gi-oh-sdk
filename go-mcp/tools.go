...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cardinfo"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YuGiOhSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yu-gi-oh_list",
		Description: "List records from YuGiOh. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yu-gi-oh_load",
		Description: "Load a single record from YuGiOh. " +
...
func runOp(client *sdk.YuGiOhSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YuGiOhSDK, name string) (sdk.YuGiOhEntity, error) {
	switch strings.ToLower(name) {
	case "cardinfo":
		return client.Cardinfo(nil), nil
