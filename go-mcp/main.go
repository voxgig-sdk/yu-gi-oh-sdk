// Command YuGiOh-mcp is an MCP server exposing the YuGiOh
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YuGiOh_list  — list records of an entity
//	YuGiOh_load  — load a single record of an entity
//
