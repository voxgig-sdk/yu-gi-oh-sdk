// Command YuGiOh-cli is a CLI + REPL for the YuGiOh SDK,
...
const prompt = "yu-gi-oh"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "cardinfo"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      YU_GI_OH_APIKEY (api key), YU_GI_OH_BASE (base url override)")
