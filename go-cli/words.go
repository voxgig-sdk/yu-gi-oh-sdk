...
func registerSDKWords(r *eng.Registry, client *sdk.YuGiOhSDK) {
...
func runOp(client *sdk.YuGiOhSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
