...
// YuGiOh SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YuGiOhOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YuGiOhOmni::structfix($now, Struct::undef()))
                        !== json_encode(YuGiOhOmni::structfix($val, Struct::undef()))) {
