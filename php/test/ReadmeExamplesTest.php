...
// YuGiOh SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YuGiOhSDK::test)
...
{
    private const SDK_CLASS = 'YuGiOhSDK';
    ...
    private const SDK_BASE = 'yugioh_sdk';
