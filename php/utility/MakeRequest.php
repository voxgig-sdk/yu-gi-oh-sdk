...
// YuGiOh SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YuGiOhMakeRequest
{
    public static function call(YuGiOhContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YuGiOhResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YuGiOhResponse($fetched);
        } else {
