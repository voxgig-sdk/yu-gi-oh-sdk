...
The PHP SDK for the YuGiOh API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Cardinfo(null)->list(null, null);
...
[$result, $err] = $client->YuGiOh(null)->load(
    ["id" => "test01"], null
);
