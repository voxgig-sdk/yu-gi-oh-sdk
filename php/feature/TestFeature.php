...
// YuGiOh SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class YuGiOhTestFeature extends YuGiOhBaseFeature
{
    ...
    public function init(YuGiOhContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (YuGiOhContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (YuGiOhContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(YuGiOhContext $ctx, $op, $args): array
    {
