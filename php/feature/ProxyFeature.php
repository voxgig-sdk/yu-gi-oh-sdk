...
class YuGiOhProxyFeature extends YuGiOhBaseFeature
{
    ...
    public function init(YuGiOhContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YuGiOhContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
