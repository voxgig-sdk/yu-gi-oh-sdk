...
class YuGiOhTimeoutFeature extends YuGiOhBaseFeature
{
    ...
    private function _with_timeout(YuGiOhContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YuGiOhContext $_ctx, float $ms): void
    {
        $client = $this->client;
