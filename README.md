...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/yu-gi-oh` | `npm install @voxgig-sdk/yu-gi-oh` |
| Python | `voxgig-sdk-yu-gi-oh` | `pip install voxgig-sdk-yu-gi-oh` |
| PHP | `voxgig-sdk/yu-gi-oh` | `composer require voxgig-sdk/yu-gi-oh` |
| Golang | `github.com/voxgig-sdk/yu-gi-oh-sdk/go` | `go get github.com/voxgig-sdk/yu-gi-oh-sdk/go` |
| Ruby | `voxgig-sdk-yu-gi-oh` | `gem install voxgig-sdk-yu-gi-oh` |
| Lua | `voxgig-sdk-yu-gi-oh` | `luarocks install voxgig-sdk-yu-gi-oh` |
