...
The Golang SDK for the YuGiOh API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/yu-gi-oh-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/yu-gi-oh-sdk=../path/to/github.com/voxgig-sdk/yu-gi-oh-sdk
```
...
```go
    result, err := client.Cardinfo(nil).List(nil, nil)
    if err != nil {
        panic(err)
    }
...
```
github.com/voxgig-sdk/yu-gi-oh-sdk/
...
The root package (`github.com/voxgig-sdk/yu-gi-oh-sdk`) re-exports everything needed
