...
func NewCardinfoEntity(client *core.YuGiOhSDK, entopts map[string]any) *CardinfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardinfoEntity) GetName() string { return e.name }
...
func (e *CardinfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardinfoEntity) Deleted() bool {
	return e.deleted
}


func (e *CardinfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardinfoEntity(e.client, opts)
}

func (e *CardinfoEntity) Data(args ...any) any {
...
func (e *CardinfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cardinfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardinfoEntity) DataTyped(data ...Cardinfo) Cardinfo {
	if len(data) > 0 {
		return typedFrom[Cardinfo](e.Data(asMap(data[0])))
	}
	return typedFrom[Cardinfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cardinfo (all fields
// optional at the wire level).
func (e *CardinfoEntity) MatchTyped(match ...Cardinfo) Cardinfo {
	if len(match) > 0 {
		return typedFrom[Cardinfo](e.Match(asMap(match[0])))
	}
	return typedFrom[Cardinfo](e.Match())
}
...
func (e *CardinfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardinfoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CardinfoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardinfoListMatch and returns []Cardinfo. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CardinfoEntity) ListTyped(reqmatch CardinfoListMatch, ctrl map[string]any) ([]Cardinfo, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cardinfo](res), nil
}



func (e *CardinfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CardinfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardinfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardinfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
