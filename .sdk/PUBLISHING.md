...
|---|---|---|
| `ts/` | @voxgig-sdk/yu-gi-oh-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yu-gi-oh-sdk \
      --repository voxgig-sdk/yu-gi-oh-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yu-gi-oh-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yu-gi-oh-sdk --id=<id>` removes it.
