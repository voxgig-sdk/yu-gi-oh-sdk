...
class YuGiOhTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YuGiOhTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = YuGiOhTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = YuGiOhTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
...
def entity_data(v):
    return YuGiOhTestRunner.entity_data(v)
...
def live_client_options():
    return YuGiOhTestRunner.live_client_options()
