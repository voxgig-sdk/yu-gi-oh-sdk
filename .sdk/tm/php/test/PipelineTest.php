...
{
    private static function utility(): YuGiOhUtility
    {
        return new YuGiOhUtility();
    }
    ...
    private static function ctx(array $over = []): YuGiOhContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YuGiOhContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YuGiOhOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YuGiOhError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YuGiOhOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YuGiOhMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YuGiOhOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YuGiOhMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YuGiOhOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YuGiOhMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YuGiOhSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YuGiOhMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YuGiOhResponse([]),
            'result' => new YuGiOhResult([]),
        ]);
        [, $err] = YuGiOhMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YuGiOhSpec(['step' => 's']),
            'response' => new YuGiOhResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YuGiOhResult([]),
        ]);
        [, $err] = YuGiOhMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YuGiOhSpec(['step' => 's']),
            'response' => new YuGiOhResponse(self::resp(200, ['v' => 1])),
            'result' => new YuGiOhResult([]),
        ]);
        [, $err] = YuGiOhMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YuGiOhSpec(['step' => 's']),
            'response' => new YuGiOhResponse(self::resp(200, ['v' => 2])),
            'result' => new YuGiOhResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YuGiOhMakeResponse::call($ctx);
    ...
    {
        $preset = new YuGiOhResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YuGiOhSpec([]),
            'response' => new YuGiOhResponse([]),
            'result' => new YuGiOhResult([]),
        ...
        [$got, $err] = YuGiOhMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YuGiOhResult([])]);
        [, $err] = YuGiOhMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YuGiOhSpec([]), 'result' => null]);
        [, $err] = YuGiOhMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YuGiOhSpec(['step' => 's']),
            'result' => new YuGiOhResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YuGiOhOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YuGiOhMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YuGiOhSpec(['step' => 's']),
            'result' => new YuGiOhResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YuGiOhOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YuGiOhMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YuGiOhResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YuGiOhSpec([]),
            'result' => new YuGiOhResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YuGiOhMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YuGiOhMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YuGiOhError('boom', 'boom');
        $utility->fetcher = function (YuGiOhContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YuGiOhSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YuGiOhMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YuGiOhContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YuGiOhMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YuGiOhResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YuGiOhContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YuGiOhSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YuGiOhMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YuGiOhResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YuGiOhSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YuGiOhMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YuGiOhMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YuGiOhMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YuGiOhResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YuGiOhDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YuGiOhResult(['ok' => false])]);
        $this->expectException(YuGiOhError::class);
        YuGiOhDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YuGiOhResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YuGiOhMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YuGiOhBaseFeature();
        $b = new YuGiOhBaseFeature();
        YuGiOhFeatureAdd::call($ctx, $a);
        YuGiOhFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YuGiOhBaseFeature
    {
        $f = new YuGiOhBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YuGiOhFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YuGiOhContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YuGiOhSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YuGiOhPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YuGiOhResponse(['headers' => null]),
            'result' => new YuGiOhResult([]),
        ]);
        YuGiOhResultHeaders::call($ctx);
