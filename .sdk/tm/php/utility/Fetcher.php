...
class YuGiOhFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YuGiOhSDK/1.0)';
    ...
    public static function call(YuGiOhContext $ctx, string $fullurl, array $fetchdef): array
    {
