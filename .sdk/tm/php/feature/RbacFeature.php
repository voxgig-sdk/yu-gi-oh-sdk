...
class YuGiOhRbacFeature extends YuGiOhBaseFeature
{
    ...
    private function _required(YuGiOhContext $ctx): ?string
    {
    ...
    private function _reject(YuGiOhContext $ctx, string $required): void
    {
    ...
    private function _track(YuGiOhContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
