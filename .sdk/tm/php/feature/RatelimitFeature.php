...
class YuGiOhRatelimitFeature extends YuGiOhBaseFeature
{
    ...
    private function _acquire(YuGiOhContext $ctx): void
    {
    ...
    private function _track(YuGiOhContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
