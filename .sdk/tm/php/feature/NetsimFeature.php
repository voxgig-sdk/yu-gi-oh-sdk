...
class YuGiOhNetsimFeature extends YuGiOhBaseFeature
{
    ...
    private function _simulate(YuGiOhContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YuGiOhContext $ctx, array $applied): void
    {
        $client = $this->client;
