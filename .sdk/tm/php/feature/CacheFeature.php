...
class YuGiOhCacheFeature extends YuGiOhBaseFeature
{
    ...
    private function _through(YuGiOhContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
