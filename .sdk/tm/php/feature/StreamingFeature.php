...
class YuGiOhStreamingFeature extends YuGiOhBaseFeature
{
    ...
    private function _iterate(YuGiOhResult $result): \Generator
    {
    ...
    private function _streamable(YuGiOhContext $ctx): bool
    {
