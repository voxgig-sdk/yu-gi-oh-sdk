...
// YuGiOh SDK clienttrack feature
...
class YuGiOhClienttrackFeature extends YuGiOhBaseFeature
{
    ...
    public function PostConstruct(YuGiOhContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YuGiOh-SDK';
