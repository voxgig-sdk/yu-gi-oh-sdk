...
describe("CardinfoDirect", function()
  it("should direct-list-cardinfo", function()
    local setup = cardinfo_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cardinfo", setup.live and "live" or "unit")
...
function cardinfo_direct_setup(mockres)
