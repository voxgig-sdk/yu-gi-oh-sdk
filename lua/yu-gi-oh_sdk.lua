...
YuGiOhSDK._make_feature = _make_feature


function YuGiOhSDK.new(options)
  local self = setmetatable({}, YuGiOhSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function YuGiOhSDK:options_map()
...
function YuGiOhSDK:get_utility()
  return Utility.copy(self._utility)
end


function YuGiOhSDK:get_root_ctx()
  return self._rootctx
end


function YuGiOhSDK:prepare(fetchargs)
...
function YuGiOhSDK:direct(fetchargs)
...
-- by passing it.
function YuGiOhSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function YuGiOhSDK:graphql(query, variables, ctrl)
...
function YuGiOhSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = YuGiOhSDK.new(sdkopts)
  sdk.mode = "test"
