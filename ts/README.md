...
| `tester(testopts?, sdkopts?)` | `YuGiOhSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `YuGiOhSDK.test(testopts?, sdkopts?)` | `YuGiOhSDK` | Create a test-mode client. |
...
| `banlist_info` | `Record<string, any>` | Banlist status information for the card |
