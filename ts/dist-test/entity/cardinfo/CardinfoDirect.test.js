...
(0, node_test_1.describe)('CardinfoDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when YU_GI_OH_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('YU_GI_OH_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.YuGiOhSDK({
    ...
    (0, node_test_1.test)('direct-list-cardinfo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cardinfo', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.YU_GI_OH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.YuGiOhSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['YU_GI_OH_TEST_CARDINFO_ENTID'];
    ...
    const client = new __1.YuGiOhSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CardinfoDirect.test.js.map