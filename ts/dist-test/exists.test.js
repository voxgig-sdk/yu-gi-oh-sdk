...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // YuGiOhSDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        const testsdk = __1.YuGiOhSDK.test();
        (0, node_assert_1.equal)(testsdk instanceof __1.YuGiOhSDK, true, 'YuGiOhSDK.test() must return a client synchronously');
    });
});
