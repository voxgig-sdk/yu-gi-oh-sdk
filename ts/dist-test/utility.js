...
function envOverride(m) {
    if ('TRUE' === process.env.YU_GI_OH_TEST_LIVE ||
        'TRUE' === process.env.YU_GI_OH_TEST_OVERRIDE) {
    ...
    m.YU_GI_OH_TEST_EXPLAIN = process.env.YU_GI_OH_TEST_EXPLAIN || m.YU_GI_OH_TEST_EXPLAIN;
    return m;
}
