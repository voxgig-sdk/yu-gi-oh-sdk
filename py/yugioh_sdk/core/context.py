...
from yugioh_sdk.core.helpers import get_ctx_prop, to_map
...
class YuGiOhContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, YuGiOhResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return YuGiOhError(code, msg, self)
