...
from yugioh_sdk.utility import register

# Load features
from yugioh_sdk.feature.base_feature import YuGiOhBaseFeature
from yugioh_sdk.features import _has_feature, _make_feature
...
class YuGiOhSDK:
    ...
    def get_utility(self):
        return YuGiOhUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YuGiOhSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cardinfo(self, data=None) -> "CardinfoEntity":
        ...
        from yugioh_sdk.entity.cardinfo_entity import CardinfoEntity
