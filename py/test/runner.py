...
class YuGiOhTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YuGiOhTestRunner.getenv("YU_GI_OH_TEST_LIVE")
        override = YuGiOhTestRunner.getenv("YU_GI_OH_TEST_OVERRIDE")
        ...
        explain = YuGiOhTestRunner.getenv("YU_GI_OH_TEST_EXPLAIN")
