...
from yugioh_sdk.core.response import YuGiOhResponse
from yugioh_sdk.core.operation import YuGiOhOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = YuGiOhSDK.test(None, None)
        ...
        class TestInitFeature(YuGiOhBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(YuGiOhBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = YuGiOhSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = YuGiOhSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = YuGiOhSDK.test(None, setup_opts)
