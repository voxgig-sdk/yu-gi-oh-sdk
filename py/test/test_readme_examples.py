# YuGiOh SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YuGiOhSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YuGiOhSDK(...) and YuGiOhSDK.test(...) become
#      YuGiOhSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yugioh_sdk"
_SDK_CLASS = "YuGiOhSDK"
